...
namespace AltTPC {
    ...
    internal class Node {
        ...
        public NodeType type = NodeType.PENDING;
        public NodeType returnedType = NodeType.PENDING;
        public string word;
        ...
        public Node(string word) {
            this.word = word;
            indexInSourceList = Interpreter.sources.Last().indexInSourceList;
            positionInSource = Interpreter.sources.Last().i;
        }
